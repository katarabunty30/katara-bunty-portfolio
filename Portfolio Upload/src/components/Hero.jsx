...
>
  ...
  <p className="mt-6 text-base md:text-lg leading-8 text-slate-400 max-w-xl mx-auto lg:mx-0">
...
lg:w-[560px] lg:h-[560px] rounded-full border border-cyan-400/15" />
...
lg:w-[530px] lg:h-[530px] rounded-full border-2 border-dashed border-cyan-400/35"
    />
...
lg:w-[495px] lg:h-[495px] rounded-full border-[5px] border-cyan-400 shadow-[0_0_35px_rgba(34,211,238,.30)]"
    />
...
className="absolute top-0 sm:top-5 right-2 sm:right-0 z-30">
  <div
    className="flex items-center gap-3 px-4 sm:px-7 py-2 sm:py-4 rounded-full
               bg-[#071321]/95
               backdrop-blur-xl
